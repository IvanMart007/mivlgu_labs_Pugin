...
\newcommand{\Subject}{Инструментальные средства разрабодки  ПО} %по ... родительный падеж
\newcommand{\Topic}{Калькулятор на WPF} %Тема
...
\ESKDsignature{МИВУ 09.02.03 ПЗ} % Код специальности и тип работы
